...
All notable changes to `visio-sentinel` will be documented in this file.
...
[Unreleased]: https://github.com/arananet/visio-sentinel/compare/v0.1.0...HEAD
[0.1.0]: https://github.com/arananet/visio-sentinel/releases/tag/v0.1.0
